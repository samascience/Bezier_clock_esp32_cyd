...
print("==========================================================")
print("📐 Drawing sample portrait clock numbers (rotation=0)...")
...
# Initialize Display in rotation=0 (Green test was successful!)
display = Display(spi, cs=Pin(15), dc=Pin(2), rst=Pin(22), width=240, height=320, rotation=0, mirror=False)

# Background (Midnight Blue 0x0862) and digits color
...
DIGITS = {
    1: [(50, 0)] * 13, # Collapse all to vertical line
