...
print("==========================================================")
print("📐 Drawing sample portrait clock numbers (rotation=0, mirror=True, bgr=False)...")
...
# Initialize Display in rotation=0, mirror=True, bgr=False (to correct Red/Blue swap!)
display = Display(spi, cs=Pin(15), dc=Pin(2), rst=Pin(22), width=240, height=320, rotation=0, mirror=True, bgr=False)

# Colors (Big-Endian for display, Little-Endian for FrameBuffer)
COLOR_BG_DIS = 0x0862      # Midnight Blue background
COLOR_BG_FB = 0x6208       
COLOR_HOUR_FB = 0x00FC     # Neon Orange
COLOR_MIN_FB = 0xFF06      # Neon Cyan
COLOR_SEC_FB = 0x9BF7      # Warm White
COLOR_COLON_DIS = 0xF79B   # Warm White
...
# Clear background and draw colon
